...
CREATE TABLE IF NOT EXISTS hisbase (
    ...
    jsfszwtg2 DECIMAL(10,2) DEFAULT 0,
    tggz DECIMAL(10,2) DEFAULT 0,
    fdgz DECIMAL(10,2) DEFAULT 0,
    fdgz2 DECIMAL(10,2) DEFAULT 0,
    jjjy DECIMAL(10,2) DEFAULT 0,
    jjjy2 DECIMAL(10,2) DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS njbt (
    tbnd VARCHAR(6) NOT NULL PRIMARY KEY,
    a1 DECIMAL(5,1) NOT NULL DEFAULT 0,
    a2 DECIMAL(5,1) NOT NULL DEFAULT 0,
    a3 DECIMAL(5,1) NOT NULL DEFAULT 0,
    a4 DECIMAL(5,1) NOT NULL DEFAULT 0
);
