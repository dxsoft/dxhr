FUNCTION crtvtgqgz2006

PARAMETERS ttUpdate,tcConn

SQLEXEC(tcConn,"select * from tgqgz2006 where dwbm='"+ALLTRIM(m.pdwbm)+"'","tgqgz2006")

IF ttUpdate
	CURSORSETPROP("tables","tgqgz2006","tgqgz2006")
	CURSORSETPROP("keyfieldlist","id","tgqgz2006")

	fn=""
	FOR i=1 TO FCOUNT("tgqgz2006")
	    IF FIELD(i,"tgqgz2006")<>"ID"
