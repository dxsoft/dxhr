...
人员维护列表支持通过“变动”按钮旁的类别菜单办理退休、调动、调出、辞职、辞退、开除和死亡等人员变动；其中“调动”按旧系统“调往本地其他单位”处理，“调出”按旧系统“调往外地”处理。在册人员转入 `dryjbxxb/hisbaseb`，学历、职务、年度考核、套改情况、套改前工资、警衔/监察等级、养老缴费基数（`jfjs` 人员年度平均工资）等成对备份表也随人员一起迁移，并可在“变动人员信息”页面恢复到在册。
